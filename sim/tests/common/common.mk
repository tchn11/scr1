...
CFLAGS_ARCH = -Wa,-march=rv32$(ARCH)_zicsr -march=rv32$(ARCH)_zicsr -mabi=$(ABI)
...
LDFLAGS   ?= -nostartfiles -nostdlib -lc -lgcc -march=rv32$(ARCH)_zicsr -mabi=$(ABI) --specs=nano.specs $(ADD_LDFLAGS)
